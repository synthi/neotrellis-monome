...
static const uint8_t allpalettes[25][3][16] = {
  ...
  // 1 (Paleta 2)
  {{0,43,52,66,80,95,110,125,140,155,170,185,200,215,230,250},{0,43,52,66,80,95,110,125,140,155,170,185,200,215,230,250},{0,22,27,34,40,48,55,62,70,77,85,92,100,107,115,125}},
  // 2 (Paleta 3) - Corregido salto Luma
  {{0, 15, 25, 36, 45, 55, 65, 75, 85, 95, 105, 115, 125, 140, 155, 175},{0, 30, 45, 70, 90, 110, 130, 150, 170, 190, 210, 225, 240, 250, 255, 255},{0, 30, 45, 70, 90, 110, 130, 150, 170, 190, 210, 225, 240, 250, 255, 255}},
  // 3 (Paleta 4) - Naranja inicial equilibrado, sin rojo crudo
  {{0, 100, 120, 150, 180, 210, 240, 255, 255, 255, 255, 255, 255, 255, 255, 255},{0, 60, 80, 100, 120, 140, 160, 180, 200, 214, 224, 231, 236, 238, 239, 240},{0, 0, 0, 0, 2, 5, 11, 20, 32, 50, 72, 97, 125, 156, 187, 220}},
  // 4 (Paleta 5) - Naranja oscuro inicial estabilizado
  {{0, 80, 88, 100, 115, 130, 145, 160, 175, 190, 205, 220, 235, 250, 255, 255},{0, 45, 55, 65, 75, 85, 95, 105, 115, 125, 135, 145, 160, 180, 200, 220},{0, 4, 5, 6, 7, 8, 9, 11, 15, 25, 39, 57, 78, 101, 126, 152}},
  ...
  {{0, 20, 40, 55, 70, 85, 100, 115, 130, 145, 160, 175, 190, 205, 220, 240},{0, 10, 15, 20, 30, 40, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185},{0, 20, 40, 55, 70, 85, 100, 115, 130, 145, 160, 175, 190, 205, 220, 240}},
  // 8 (Paleta 9) - Unificación de matriz (Eliminado el 77 en el índice apagado)
  {{0, 12, 25, 35, 45, 55, 70, 90, 110, 130, 150, 170, 190, 210, 230, 250},{0, 10, 20, 30, 40, 55, 70, 90, 110, 130, 150, 170, 190, 210, 230, 245},{0, 30, 55, 75, 95, 115, 130, 145, 155, 165, 175, 185, 200, 215, 230, 240}},
  // 9 (Paleta 10)
  ...
  // 11 (Paleta 12) - THE HOLY GRAIL PALETTE
  ...
  {{0, 15, 15, 30, 50, 70, 90, 110, 130, 150, 170, 190, 210, 225, 240, 255},{0, 45, 45, 65, 85, 105, 125, 145, 165, 185, 205, 220, 235, 245, 255, 255},{0, 80, 80, 100, 120, 140, 160, 180, 200, 215, 230, 240, 250, 255, 255, 255}},
  // 18 (Paleta 19)
  ...
  // 22 (Paleta 23)
  {{0, 35, 45, 70, 100, 130, 160, 190, 215, 235, 250, 255, 255, 255, 255, 255},{0, 0, 0, 5, 15, 30, 50, 75, 100, 130, 160, 190, 215, 235, 250, 255},{0, 70, 100, 130, 160, 190, 215, 235, 250, 255, 255, 255, 255, 255, 255, 255}},
  // 23 (Paleta 24) - Cierre Cálido/Rosa (Erradicado el amarillo tóxico)
  {{15, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 255, 255, 255},{0, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 80, 120, 200},{0, 40, 60, 80, 90, 100, 110, 120, 130, 140, 150, 170, 200, 220, 240, 255}},
  // 24 (Paleta 25)
